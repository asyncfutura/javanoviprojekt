...
import hr.adinfo.client.ui.clientssuppliers.ClientAppSuppliersAddEditDialog;
 ...
 * @author Matej
 */
public class ClientAppSelectSupplierDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppSelectSupplierDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT ID, NAME, OIB, CONTACT_PERSON, TELEPHONE_NUM, MOBILE_NUM FROM SUPPLIERS WHERE IS_DELETED = 0 AND ID != 0");
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"Šifra", "Dobavljač", "OIB", "Kontakt osoba", "Telefon", "Mobitel"});
					...
					jTable1.getColumnModel().getColumn(4).setPreferredWidth(jScrollPane1.getWidth() * 20 / 100);
					jTable1.getColumnModel().getColumn(5).setPreferredWidth(jScrollPane1.getWidth() * 20 / 100);
				}
    ...
    private void initComponents() {
        ...
        jButtonAdd.setText("<html> <div style=\"text-align: center\"> Dodaj novog <br> dobavljača <br> [INS] </div> </html>");
