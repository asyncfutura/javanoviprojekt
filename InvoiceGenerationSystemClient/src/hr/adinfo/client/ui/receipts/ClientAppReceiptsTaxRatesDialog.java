 ...
 * @author Matej
 */
public class ClientAppReceiptsTaxRatesDialog extends javax.swing.JDialog {
	private ArrayList<Integer> tableIdList = new ArrayList<>();
	
	/**
	 * Creates new form ClientAppWarehouseCategoriesDialog
	 */
	public ClientAppReceiptsTaxRatesDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
			...
			public boolean dispatchKeyEvent(KeyEvent ke) {
				...
				if(ke.getID() == KeyEvent.KEY_PRESSED){
					if(ke.getKeyCode() == KeyEvent.VK_ESCAPE){
						...
						//jButtonEmployeesActionPerformed(null);
	...
	private void RefreshTable(){
		...
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT ID, NAME, VALUE FROM RECEIPT_TAX_RATES WHERE IS_DELETED = 0");
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					jTable1.getColumnModel().getColumn(2).setPreferredWidth(jScrollPane1.getWidth() * 30 / 100);
				}
    ...
    private void initComponents() {
        ...
        setTitle("Primke - ulazne porezne stope");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Primke - ulazne porezne stope");
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ClientAppReceiptsTaxRatesAddEditDialog addEditdialog = new ClientAppReceiptsTaxRatesAddEditDialog(null, true, -1);
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        ClientAppReceiptsTaxRatesAddEditDialog addEditdialog = new ClientAppReceiptsTaxRatesAddEditDialog(null, true, tableId);
        addEditdialog.setVisible(true);
        if(addEditdialog.changeSuccess){
            RefreshTable();
        }
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if(dialogResult == JOptionPane.YES_OPTION){
            ...
            String query = "UPDATE RECEIPT_TAX_RATES SET IS_DELETED = ? WHERE ID = ?";
    ...
    private void jButtonPrintA4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintA4ActionPerformed
        PrintUtils.PrintA4Table("UlaznePorezneStope", "Ulazne porezne stope", jTable1, "");
    ...
    private void jButtonPrintPosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintPosActionPerformed
        PrintUtils.PrintPosTable("Ulazne porezne stope", jTable1, new int[]{0, 1, 2});
