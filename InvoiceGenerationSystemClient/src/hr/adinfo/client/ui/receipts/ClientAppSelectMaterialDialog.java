...
import hr.adinfo.client.ui.warehouse.ClientAppWarehouseMaterialsAddEditDialog;
 ...
 * @author Matej
 */
public class ClientAppSelectMaterialDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppSelectMaterialDialog(java.awt.Frame parent, boolean modal, int currentYear) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		String query = "SELECT MATERIALS.ID, MATERIALS.NAME, "
				+ "MATERIAL_AMOUNTS.AMOUNT - (" + localInvoiceAmountsSubquery + "), MEASURING_UNITS.NAME "
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"Šifra", "Naziv", "Trenutno stanje", "Mjerna jedinica"});
    ...
    private void initComponents() {
        ...
        jButtonAdd.setText("<html> <div style=\"text-align: center\"> Dodaj novi <br> materijal <br> [INS] </div> </html>");
