 ...
 * @author Matej
 */
public class ClientAppSettingsDiscountsDialog extends javax.swing.JDialog {
	private ArrayList<Integer> tableIdList = new ArrayList<>();
	
	/**
	 * Creates new form ClientAppWarehouseCategoriesDialog
	 */
	public ClientAppSettingsDiscountsDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT ID, VALUE, TYPE FROM DISCOUNTS WHERE IS_DELETED = 0 ORDER BY TYPE, VALUE");
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"Šifra", "Iznos"});
					...
					while (databaseQueryResult.next()) {
						...
						if(databaseQueryResult.getInt(2) == Values.SETTINGS_DISCOUNT_TYPE_PERCENTAGE){
							...
							rowData[1] = ClientAppUtils.FloatToPriceString(databaseQueryResult.getFloat(1)) + " kn";
						}
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        ClientAppSettingsDiscountsAddEditDialog addEditdialog = new ClientAppSettingsDiscountsAddEditDialog(null, true, tableId);
        addEditdialog.setVisible(true);
        if(addEditdialog.changeSuccess){
            RefreshTable();
        }
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog (null, "Jeste li sigurni da želite obrisati popust " + tableValue, "Obriši popust", JOptionPane.YES_NO_OPTION);
        if(dialogResult == JOptionPane.YES_OPTION){
            final JDialog loadingDialog = new LoadingDialog(null, true);
            
            String query = "UPDATE DISCOUNTS SET IS_DELETED = ? WHERE ID = ?";
    ...
    private void jButtonPrintA4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintA4ActionPerformed
        PrintUtils.PrintA4Table("Popusti", "Popusti", jTable1, "");
    ...
    private void jButtonPrintPosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintPosActionPerformed
		PrintUtils.PrintPosTable("Popusti", jTable1);
