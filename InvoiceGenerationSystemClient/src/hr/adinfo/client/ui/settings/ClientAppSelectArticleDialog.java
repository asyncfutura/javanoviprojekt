 ...
 * @author Matej
 */
public class ClientAppSelectArticleDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppSelectArticleDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		String query = "SELECT ARTICLES.ID, ARTICLES.NAME, ARTICLES.PRICE, MEASURING_UNITS.NAME, ARTICLES.CUSTOM_ID "
				+ "FROM ARTICLES "
