 ...
 * @author Matej
 */
public class ClientAppSelectStaffDialog extends javax.swing.JDialog {
	
	private ArrayList<Integer> tableIdList = new ArrayList<>();
	
	public int selectedId = -1;
	public String selectedName = "";
	public String selectedOib = "";
	
	/**
	 * Creates new form ClientAppWarehouseCategoriesDialog
	 */
	public ClientAppSelectStaffDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		String query = "SELECT ID, FIRST_NAME, LAST_NAME, OIB "
				+ "FROM STAFF "
				+ "WHERE IS_DELETED = 0 AND OFFICE_NUMBER = ? AND ID != 0";
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"Djelatnik", "OIB"});
					ArrayList<Integer> idList = new ArrayList<>();
					while (databaseQueryResult.next()) {
						Object[] rowData = new Object[2];
						rowData[0] = databaseQueryResult.getString(1) + " " + databaseQueryResult.getString(2);
						rowData[1] = databaseQueryResult.getString(3);
					...
					jTable1.getColumnModel().getColumn(0).setPreferredWidth(jScrollPane1.getWidth() * 60 / 100);
    ...
    private void jButtonSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelectActionPerformed
        ...
        selectedName = String.valueOf(jTable1.getModel().getValueAt(rowId, 0));
        selectedOib = String.valueOf(jTable1.getModel().getValueAt(rowId, 1));
