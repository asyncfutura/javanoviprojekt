...
import static hr.adinfo.client.fiscalization.Fiscalization.GetPrivateCertificateBytes;
import static hr.adinfo.client.fiscalization.Fiscalization.GetPrivateCertificatePass;
 ...
 * @author Matej
 */
public class ClientAppSettingsFiscalisationDialog extends javax.swing.JDialog {
	...
	public ClientAppSettingsFiscalisationDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
		...
		jSpinnerWaitTime.setValue(ClientAppSettings.GetInt(Values.AppSettingsEnum.SETTINGS_FISCALISATION_WAITTIME.ordinal()));
		jSpinnerWaitTimeRepeat.setValue(ClientAppSettings.GetInt(Values.AppSettingsEnum.SETTINGS_FISCALISATION_WAITTIME_REPEAT.ordinal()));
	...
	private void RefreshCertificateInfo(){
		...
		try {
			...
			char[] password = GetPrivateCertificatePass(Values.CERT_TYPE_PROD).toCharArray();
			keyStore.load(new ByteArrayInputStream(GetPrivateCertificateBytes(Values.CERT_TYPE_PROD)), password);
    ...
    private void initComponents() {
        ...
        jSpinnerWaitTimeRepeat = new javax.swing.JSpinner();
        ...
        jTextFieldEchoMessage.setPreferredSize(new java.awt.Dimension(200, 22));
        ...
        jLabel37.setText("Vrijeme čekanja:");
        jLabel37.setPreferredSize(new java.awt.Dimension(220, 14));

        jLabel38.setText("Vrijeme čekanja kod ponovnog slanja:");
        jLabel38.setPreferredSize(new java.awt.Dimension(220, 14));

        jSpinnerWaitTime.setModel(new javax.swing.SpinnerNumberModel(10, 2, 30, 1));
        jSpinnerWaitTime.setPreferredSize(new java.awt.Dimension(50, 22));

        jSpinnerWaitTimeRepeat.setModel(new javax.swing.SpinnerNumberModel(60, 2, 120, 1));
        jSpinnerWaitTimeRepeat.setPreferredSize(new java.awt.Dimension(50, 22));
        ...
        jLabel12.setText("sekundi.");

        jLabel13.setText("sekundi.");
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jSpinnerWaitTimeRepeat, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
		ClientAppSettings.SetInt(Values.AppSettingsEnum.SETTINGS_FISCALISATION_WAITTIME.ordinal(), ((Number)jSpinnerWaitTime.getValue()).intValue());
		ClientAppSettings.SetInt(Values.AppSettingsEnum.SETTINGS_FISCALISATION_WAITTIME_REPEAT.ordinal(), ((Number)jSpinnerWaitTimeRepeat.getValue()).intValue());
		ClientAppSettings.SaveSettings();
		
		boolean newIsInVatSystem = jRadioButtonInVatSystem.isSelected();
		
		if(newIsInVatSystem != isInVatSystem){
			final JDialog loadingDialog = new LoadingDialog(null, true);
			
			MultiDatabaseQuery multiDatabaseQuery = new MultiDatabaseQuery(4);
			multiDatabaseQuery.SetQuery(0, "UPDATE GLOBAL_VALUES_TABLE SET VALUE = ? WHERE NAME = 'VATSystem'");
			multiDatabaseQuery.AddParam(0, 1, newIsInVatSystem ? 1 : 0);
			
			if(newIsInVatSystem){
				multiDatabaseQuery.SetQuery(1, "UPDATE ARTICLES SET TAX_RATE_ID = 1");
				multiDatabaseQuery.SetQuery(2, "UPDATE SERVICES SET TAX_RATE_ID = 1");
				multiDatabaseQuery.SetQuery(3, "UPDATE TRADING_GOODS SET TAX_RATE_ID = 1");
			} else {
				multiDatabaseQuery.SetQuery(1, "UPDATE ARTICLES SET TAX_RATE_ID = 0");
				multiDatabaseQuery.SetQuery(2, "UPDATE SERVICES SET TAX_RATE_ID = 0");
				multiDatabaseQuery.SetQuery(3, "UPDATE TRADING_GOODS SET TAX_RATE_ID = 0");
			}
    ...
    private void jButtonEchoTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEchoTestActionPerformed
		...
		String response = Fiscalization.FiscalisationEcho(jTextFieldEchoMessage.getText());
    ...
    private void jButtonImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImportActionPerformed
		LoadCertificate(Values.CERT_TYPE_PROD);
    ...
    private void jButtonImportDemoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImportDemoActionPerformed
		LoadCertificate(Values.CERT_TYPE_TEST);
    }//GEN-LAST:event_jButtonImportDemoActionPerformed
	
	private void LoadCertificate(int certType){
		JFileChooser chooser = new JFileChooser();
		chooser.setDialogTitle("Učitaj certifikat" + ((certType == Values.CERT_TYPE_PROD) ? " - Produkcija" : " - Test"));
		...
		try {
			...
			if(keyStore.aliases().hasMoreElements()){
				...
				if(!cert.getSubjectDN().getName().contains(Licence.GetOIB())){
					if(certType == Values.CERT_TYPE_PROD){
    ...
    private javax.swing.JSpinner jSpinnerWaitTimeRepeat;
