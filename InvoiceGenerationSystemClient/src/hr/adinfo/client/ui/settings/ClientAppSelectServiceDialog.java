...
import hr.adinfo.client.ui.warehouse.ClientAppWarehouseServicesAddEditDialog;
 ...
 * @author Matej
 */
public class ClientAppSelectServiceDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppSelectServiceDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		String query = "SELECT SERVICES.ID, SERVICES.NAME, SERVICES.PRICE, MEASURING_UNITS.NAME, SERVICES.CUSTOM_ID "
				+ "FROM SERVICES "
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"Šifra", "Naziv", "Cijena", "Mjerna jedinica"});
    ...
    private void initComponents() {
        ...
        jButtonAdd.setText("<html> <div style=\"text-align: center\"> Dodaj novu <br> uslugu <br> [INS] </div> </html>");
