 ...
 * @author Matej
 */
public class ClientAppSelectOfficeDialog extends javax.swing.JDialog {
	
	private ArrayList<Integer> tableIdList = new ArrayList<>();
	private ArrayList<String> tableAddressList = new ArrayList<>();
	 ...
	 */
	public ClientAppSelectOfficeDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT OFFICE_NUMBER, ADDRESS FROM OFFICES WHERE IS_DELETED = 0");
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"Redni broj poslovnice", "Adresa"});
					...
					while (databaseQueryResult.next()) {
						...
						addressList.add(databaseQueryResult.getString(1));
					}
					jTable1.setModel(customTableModel);
					tableIdList = idList;
					tableAddressList = addressList;
    ...
    private void initComponents() {
        ...
        setTitle("Odabir odredišne poslovnice");
        setResizable(false);
        ...
        jLabel2.setText("Odabir odredišne poslovnice");
    ...
    private void jButtonSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelectActionPerformed
		...
		selectedAddress = tableAddressList.get(rowId);
