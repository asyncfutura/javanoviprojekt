 ...
 * @author Matej
 */
public class ClientAppLoginDialog extends javax.swing.JDialog {
	/**
	...
	public ClientAppLoginDialog(java.awt.Frame parent, boolean modal, boolean changeCurrentUserOnSuccess, int fixedStaffId) {
		super(parent, modal);
		initComponents();
		...
		KeyboardFocusManager.getCurrentKeyboardFocusManager().addKeyEventDispatcher(new KeyEventDispatcher() {
			...
			public boolean dispatchKeyEvent(KeyEvent ke) {
				...
				if(ke.getID() == KeyEvent.KEY_PRESSED){
					if(ke.getKeyCode() == KeyEvent.VK_ESCAPE && !ClientAppSettings.GetBoolean(Values.AppSettingsEnum.SETTINGS_PASS_ESCAPEBUTTON.ordinal())){
		...
		if(fixedStaffId != -1){
			...
			jLabelTitle.setText("Potvrda lozinke");
                ...
                if (ClientAppSettings.GetBoolean(Values.AppSettingsEnum.SETTINGS_PASS_CANCELBUTTON.ordinal())){
	...
	//REMOVED_06_12_2023	}
		...
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT FIRST_NAME, LAST_NAME, OIB, RIGHTS FROM STAFF WHERE PASSWORD = ?");
				...
				if(databaseQueryResult != null){
					if (databaseQueryResult.next()) {
						...
						if(changeCurrentUserOnSuccess || true){
							...
							staffUserInfo.userOIB = databaseQueryResult.getString(2);
