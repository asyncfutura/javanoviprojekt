 ...
 * @author Matej
 */
public class ClientAppSelectInvoiceDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppSelectInvoiceDialog(java.awt.Frame parent, boolean modal, String title) {
		super(parent, modal);
		initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("Storno računa");

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        jLabel1.setText("Datum računa:");
    ...
    private void jButtonCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCheckActionPerformed
		...
		if(invoiceNumberString.length != 3 && invoiceNumberString.length != 2){
