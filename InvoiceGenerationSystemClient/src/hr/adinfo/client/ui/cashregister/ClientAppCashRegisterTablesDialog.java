 ...
 * @author Matej
 */
public class ClientAppCashRegisterTablesDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppCashRegisterTablesDialog(java.awt.Frame parent, boolean modal, int selectedTableId, int cashRegisterNumber, boolean isEmpty) {
		super(parent, modal);
		initComponents();
		...
		if (ClientAppSettings.GetBoolean(Values.AppSettingsEnum.SETTINGS_PASS_ESCAPEBUTTON.ordinal())){
                    jButtonExit.setEnabled(false);
                }
		...
		if(selectedTableId != -1){
			jButtonList[selectedTableId].setIcon(new ColorIcon(Values.SETTINGS_LAYOUT_COLORS[2], jButtonList[selectedTableId].getWidth() - Values.SETTINGS_LAYOUT_COLOR_OFFSET, jButtonList[selectedTableId].getHeight() - Values.SETTINGS_LAYOUT_COLOR_OFFSET));
                 ...
                 if (StaffUserInfo.GetCurrentUserInfo().firstName.length() > 0){
                                ...
                                if(!databaseQueryTask.isDone()){
                                        ...
                                        try {
                                                ...
                                                if(databaseQueryResult != null){
                                                 ClientAppLogger.GetInstance().LogMessage("After database query, current staff Id is: " + currentStaffId);
                                                 ...
                                                 ClientAppLogger.GetInstance().LogMessage("After method execute, current staff name is: " + StaffUserInfo.GetCurrentUserInfo().firstName);
                                                }
		...
		jLabelStaffName.setText(StaffUserInfo.GetCurrentUserInfo().userId + "-" + StaffUserInfo.GetCurrentUserInfo().firstName);
                ClientAppLogger.GetInstance().LogMessage("After method execute, current staff Id is after everything: " +  StaffUserInfo.GetCurrentUserInfo().userId);
...
//		
    ...
    private void initComponents() {
        ...
        setTitle("Stolovi");
        setPreferredSize(new java.awt.Dimension(981, 800));
        setResizable(false);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jTextFieldTableNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(42, 42, 42)
                .addComponent(jButtonDeleteAll, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButtonSelect, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton51, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton91, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
    ...
    private void jButtonDeleteAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteAllActionPerformed
		int dialogResult = JOptionPane.showConfirmDialog (null, "Jeste li sigurni da želite obrisati sve stolove?", "Obriši stolove", JOptionPane.YES_NO_OPTION);
                if(dialogResult != JOptionPane.YES_OPTION || StaffUserInfo.GetCurrentUserInfo().userRightsType != Values.STAFF_RIGHTS_ADMIN){
			...
			// Authorization
					...
					if(!dialog.loginSuccess){
						return;
                                ...
                                }else if(!isTableFree && StaffUserInfo.GetCurrentUserInfo().userId != tableStaffId[index]){
