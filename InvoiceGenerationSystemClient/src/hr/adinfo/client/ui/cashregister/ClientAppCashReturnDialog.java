 ...
 * @author Matej
 */
public class ClientAppCashReturnDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppCashReturnDialog(java.awt.Frame parent, boolean modal, float invoicePrice) {
		super(parent, modal);
		initComponents();
		...
		jLabelInvoicePrice.setText(ClientAppUtils.FloatToPriceString(invoicePrice));
		EvaluatePrice();
	...
	private void EvaluatePrice(){
		...
		jLabelToReturn.setText(ClientAppUtils.FloatToPriceString(price - invoicePrice));
	}
    ...
    private void initComponents() {
        ...
        jLabelInvoicePrice = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        jTextField1 = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        jLabelToReturn = new javax.swing.JLabel();
        ...
        jButtonSelect.setText("<html> <div style=\"text-align: center\"> Ispis računa <br> [ENTER] </div> </html>");
        jButtonSelect.setPreferredSize(new java.awt.Dimension(120, 80));
        ...
        jLabel1.setText("Iznos računa:");

        jLabelInvoicePrice.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabelInvoicePrice.setText("0.00");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("Primljeno:");
        ...
        jLabel3.setText("Za vratiti:");

        jLabelToReturn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelToReturn.setText("0.00");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jLabelInvoicePrice))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jLabelTitle.setText("Povrat gotovine");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
		AddToReceivedAmount(10);
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
		AddToReceivedAmount(20);
    }//GEN-LAST:event_jButton12ActionPerformed

    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
		AddToReceivedAmount(50);
    }//GEN-LAST:event_jButton13ActionPerformed

    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
		AddToReceivedAmount(100);
	...
	private void AddToReceivedAmount(float amount){
		float price = 0f;
		...
		if(price != (int)price){
			jTextField1.setText(ClientAppUtils.FloatToPriceString(price));
		} else {
			jTextField1.setText("" + ((int)price));
		}
    ...
    private javax.swing.JLabel jLabelInvoicePrice;
    private javax.swing.JLabel jLabelTitle;
    private javax.swing.JLabel jLabelToReturn;
