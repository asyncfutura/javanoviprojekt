 ...
 * @author Matej
 */
public class ClientAppKeyboardDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppKeyboardDialog(java.awt.Frame parent, boolean modal, String title, String defaultText, int maxTextSize) {
		super(parent, modal);
		initComponents();
    ...
    private void jButtonSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelectActionPerformed
		enteredText = jTextField1.getText().trim();
    ...
    private void jTextField1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyTyped
        if (jTextField1.getText().length() >= maxTextSize) {
            getToolkit().beep();
            evt.consume();
        }
		
		if (jTextField1.getText().length() > maxTextSize) {
            jTextField1.setText(jTextField1.getText().substring(0, maxTextSize));
        }
