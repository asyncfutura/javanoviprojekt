 ...
 * @author Matej
 */
public class ClientAppLoginPasswordOnlyDialog extends javax.swing.JDialog {
	/**
	...
	public ClientAppLoginPasswordOnlyDialog(java.awt.Frame parent, boolean modal, boolean changeCurrentUserOnSuccess, int fixedStaffId) {
		super(parent, modal);
		initComponents();
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
		...
		if(adminPass.equals(pass)){
			loginSuccess = true;
			StaffUserInfo staffUserInfo = new StaffUserInfo(Values.STAFF_RIGHTS_ADMIN);
			staffUserInfo.fullName = "admin admin";
			staffUserInfo.firstName = "admin";
			staffUserInfo.userOIB = "00000000001";
			staffUserInfo.userId = 0;
		...
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT FIRST_NAME, LAST_NAME, OIB, RIGHTS, ID FROM STAFF WHERE PASSWORD = ?");
				...
				if(databaseQueryResult != null){
					if (databaseQueryResult.next()) {
						...
						if(changeCurrentUserOnSuccess || true){
							...
							staffUserInfo.userId = databaseQueryResult.getInt(4);
							staffUserInfo.LoadStaffRights();
							StaffUserInfo.SetCurrentUserInfo(staffUserInfo);
						}
