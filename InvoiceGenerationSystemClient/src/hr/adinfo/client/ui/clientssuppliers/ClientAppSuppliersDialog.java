 ...
 * @author Matej
 */
public class ClientAppSuppliersDialog extends javax.swing.JDialog {
	private ArrayList<Integer> tableIdList = new ArrayList<>();
	
	/**
	 * Creates new form ClientAppWarehouseCategoriesDialog
	 */
	public ClientAppSuppliersDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT ID, NAME, OIB, CONTACT_PERSON, MOBILE_NUM, TELEPHONE_NUM FROM SUPPLIERS WHERE IS_DELETED = 0 AND ID != 0");
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"Šifra", "Naziv", "OIB", "Kontakt osoba", "Mobitel", "Telefon"});
    ...
    private void initComponents() {
        ...
        jButtonTraffic = new javax.swing.JButton();
        ...
        jButtonTraffic.setText("<html> <div style=\"text-align: center\"> Promet <br> [F6] </div> </html>");
        jButtonTraffic.setPreferredSize(new java.awt.Dimension(80, 70));
        jButtonTraffic.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonTrafficActionPerformed(evt);
            }
        });
        ...
        jPanelButtonsLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelButtonsLayout.createSequentialGroup()
                ...
                .addGap(50, 50, 50)
                .addComponent(jButtonTraffic, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanelButtonsLayout.createSequentialGroup()
                ...
                .addGroup(jPanelButtonsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelButtonsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jButtonTraffic, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ClientAppSuppliersAddEditDialog addEditdialog = new ClientAppSuppliersAddEditDialog(null, true, -1);
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        ClientAppSuppliersAddEditDialog addEditdialog = new ClientAppSuppliersAddEditDialog(null, true, tableId);
        addEditdialog.setVisible(true);
        if(addEditdialog.changeSuccess){
            RefreshTable();
        }
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog (null, "Jeste li sigurni da želite obrisati dobavljača " + tableValue, "Obriši dobavljača", JOptionPane.YES_NO_OPTION);
        if(dialogResult == JOptionPane.YES_OPTION){
            final JDialog loadingDialog = new LoadingDialog(null, true);
            

            String query = "UPDATE SUPPLIERS SET IS_DELETED = ? WHERE ID = ?";
    ...
    private void jButtonTrafficActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTrafficActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jButtonTrafficActionPerformed
    ...
    private void jButtonPrintPosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintPosActionPerformed
        PrintUtils.PrintPosTable("Dobavljači", jTable1, new int[]{0, 1, 2});
    ...
    private void jButtonPrintA4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintA4ActionPerformed
        PrintUtils.PrintA4Table("Dobavljači", "Dobavljači", jTable1, "");
    ...
    private javax.swing.JButton jButtonTraffic;
