 ...
 * @author Matej
 */
public class ClientAppWarehousePackagingRefundsAddEditDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppWarehousePackagingRefundsAddEditDialog(java.awt.Frame parent, boolean modal, int tableId) {
		super(parent, modal);
		initComponents();
	...
	private void SetupDialogForEdit(){
		jLabelTitle.setText("Uredi povratnu naknadu");
		setTitle("Uredi povratnu naknadu");
		
		final JDialog loadingDialog = new LoadingDialog(null, true);
		
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT NAME, VALUE FROM PACKAGING_REFUNDS WHERE ID = ?");
    ...
    private void initComponents() {
        ...
        setTitle("Dodaj povratnu naknadu");
        setResizable(false);

        jLabelTitle.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelTitle.setText("Dodaj povratnu naknadu");
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
		...
		if("".equals(name)){
            ClientAppLogger.GetInstance().ShowMessage("Unesite ime povratne naknade");
            return;
        }
		if(jFormattedTextFieldValue.getValue() == null){
            ClientAppLogger.GetInstance().ShowMessage("Unesite iznos povratne naknade");
            return;
        }
        ...
        if(tableId == -1){
            query = "INSERT INTO PACKAGING_REFUNDS (ID, NAME, VALUE, IS_DELETED) "
            + "VALUES (?, ?, ?, ?)";
            databaseQuery = new DatabaseQuery(query);
            databaseQuery.SetAutoIncrementParam(1, "ID", "PACKAGING_REFUNDS");
            databaseQuery.AddParam(2, name);
            databaseQuery.AddParam(3, value);
            databaseQuery.AddParam(4, 0);
        } else {
            query = "UPDATE PACKAGING_REFUNDS SET NAME = ?, VALUE = ? WHERE ID = ?";
            databaseQuery = new DatabaseQuery(query);
