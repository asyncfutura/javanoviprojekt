 ...
 * @author Matej
 */
public class ClientAppWarehouseServicesDialog extends javax.swing.JDialog {
	private ArrayList<Integer> tableIdList = new ArrayList<>();

	/**
	 * Creates new form ClientAppWarehouseMaterialsDialog
	 */
	public ClientAppWarehouseServicesDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		String query = "SELECT SERVICES.ID, SERVICES.NAME, SERVICES.PRICE, TAX_RATES.VALUE, MEASURING_UNITS.NAME, "
				+ "SERVICES.CUSTOM_ID, SERVICES.IS_ACTIVE "
				+ "FROM ((SERVICES INNER JOIN TAX_RATES ON SERVICES.TAX_RATE_ID = TAX_RATES.ID) "
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"Šifra", "Naziv", "Porezna stopa", "Cijena", "Mjerna jedinica"});
					...
					while (databaseQueryResult.next()) {
						...
						if(databaseQueryResult.getInt(6) == 1){
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
		ClientAppWarehouseServicesAddEditDialog addEditdialog = new ClientAppWarehouseServicesAddEditDialog(null, true, -1);
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        ClientAppWarehouseServicesAddEditDialog addEditdialog = new ClientAppWarehouseServicesAddEditDialog(null, true, tableId);
        addEditdialog.setVisible(true);
        if(addEditdialog.changeSuccess){
            RefreshTable();
        }
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        int dialogResult = JOptionPane.showConfirmDialog (null, "Jeste li sigurni da želite obrisati uslugu " + tableValue, "Obriši uslugu", JOptionPane.YES_NO_OPTION);
        if(dialogResult == JOptionPane.YES_OPTION){
			final JDialog loadingDialog = new LoadingDialog(null, true);
			

			String query = "UPDATE SERVICES SET IS_DELETED = ? WHERE ID = ?";
			DatabaseQuery databaseQuery = new DatabaseQuery(query);
    ...
    private void jButtonPrintPosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintPosActionPerformed
		PrintUtils.PrintPosTable("Usluge", jTable1, new int[]{0, 1, 3});
    ...
    private void jButtonPrintA4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintA4ActionPerformed
        PrintUtils.PrintA4Table("Usluge", "Usluge", jTable1, "");
