 ...
 * @author Matej
 */
public class ClientAppWarehouseCategoriesAddEditDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppWarehouseCategoriesAddEditDialog(java.awt.Frame parent, boolean modal, int tableId) {
		super(parent, modal);
		initComponents();
	...
	private void SetupDialogForEdit(){
		jLabelTitle.setText("Uredi kategoriju");
		setTitle("Uredi kategoriju");
		
		final JDialog loadingDialog = new LoadingDialog(null, true);
		
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT NAME FROM CATEGORIES WHERE ID = ?");
    ...
    private void initComponents() {
        ...
        jLabelTitle.setText("Dodaj kategoriju");
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if("".equals(name)){
            ClientAppLogger.GetInstance().ShowMessage("Unesite ime kategorije");
            return;
        }
        ...
        if(tableId == -1){
            query = "INSERT INTO CATEGORIES (ID, NAME, IS_DELETED) "
            + "VALUES (?, ?, ?)";
            databaseQuery = new DatabaseQuery(query);
            databaseQuery.SetAutoIncrementParam(1, "ID", "CATEGORIES");
