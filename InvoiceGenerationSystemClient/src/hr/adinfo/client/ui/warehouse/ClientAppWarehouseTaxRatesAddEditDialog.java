 ...
 * @author Matej
 */
public class ClientAppWarehouseTaxRatesAddEditDialog extends javax.swing.JDialog {
	 ...
	 */
	public ClientAppWarehouseTaxRatesAddEditDialog(java.awt.Frame parent, boolean modal, int tableId) {
		super(parent, modal);
		initComponents();
	...
	private void SetupDialogForEdit(){
		jLabelTitle.setText("Uredi poreznu stopu");
		setTitle("Uredi poreznu stopu");
		
		final JDialog loadingDialog = new LoadingDialog(null, true);
		
		DatabaseQuery databaseQuery = new DatabaseQuery("SELECT NAME, VALUE FROM TAX_RATES WHERE ID = ?");
    ...
    private void initComponents() {
        ...
        setTitle("Dodaj poreznu stopu");
        setResizable(false);

        jLabelTitle.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabelTitle.setText("Dodaj poreznu stopu");
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if(tableId == -1){
            query = "INSERT INTO TAX_RATES (ID, NAME, VALUE, IS_DELETED) "
            + "VALUES (?, ?, ?, ?)";
            databaseQuery = new DatabaseQuery(query);
            databaseQuery.SetAutoIncrementParam(1, "ID", "TAX_RATES");
            databaseQuery.AddParam(2, name);
            databaseQuery.AddParam(3, value);
            databaseQuery.AddParam(4, 0);
        } else {
            query = "UPDATE TAX_RATES SET NAME = ?, VALUE = ? WHERE ID = ?";
            databaseQuery = new DatabaseQuery(query);
