 ...
 * @author Matej
 */
public class ControlAppAddOfficeSelectCompanyDialog extends javax.swing.JDialog {
	 ...
	 */
	public ControlAppAddOfficeSelectCompanyDialog(java.awt.Frame parent, boolean modal) {
		super(parent, modal);
		initComponents();
	...
	private void RefreshTable(){
		...
		String query = "SELECT ID, NAME FROM COMPANIES ORDER BY ID ASC";
		...
		if(!databaseQueryTask.isDone()){
			...
			try {
				...
				if(databaseQueryResult != null){
					...
					customTableModel.setColumnIdentifiers(new String[] {"ID", "Naziv"});
    ...
    private void initComponents() {
        ...
        jButtonAdd.setText("<html> <div style=\"text-align: center\"> Dodaj novog <br> korisnika <br> [INS] </div> </html>");
    ...
    private void jButtonSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelectActionPerformed
        ...
        if(rowId == -1){
            ControlAppLogger.GetInstance().ShowMessage("Odaberite red u tablici koji želite odabrati.");
            return;
        }
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ControlAppCompanyAddEditDialog addEditdialog = new ControlAppCompanyAddEditDialog(null, true, -1);
